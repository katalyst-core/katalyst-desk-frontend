<script lang="ts">
	...
	import { Plus, Trash, ArrowLeft } from 'lucide-svelte';
...
<LoadingPage loading={isFormLoading}>
	<div class="flex flex-col items-center">
		<div class="max-w-xl space-y-4">
			<div class="flex w-full items-center gap-4 font-semibold text-xl">
				<Button href="/app/product/manage" variant="outline" class="w-10 h-10 p-0">
					<ArrowLeft />
				</Button>
			...
			<form use:enhance class="grid max-w-xl w-full gap-4">
				<Card.Root>
					<Card.Header>
				...
				<Card.Root>
					...
					<Card.Content class="grid gap-4">
						...
						<Form.Fieldset {form} name="wholesale">
							...
							<Button class="w-full" on:click={addWholesalePrice}>
								<Plus class="w-5 h-5" />
								Add Price
							</Button>
						</Form.Fieldset>
			...
			<div class="max-w-xl space-y-4">
				<div class="flex w-full justify-end items-center gap-4 font-semibold text-xl">
					<Button>
						Create Product
					</Button>
				</div>
